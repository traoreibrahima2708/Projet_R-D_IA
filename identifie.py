...
class Identifie :
    def __init__(self):
        ...
        while True:
            ...
            faces=face_cascade.detectMultiScale(gray, scaleFactor=1.2,minNeighbors=4, minSize=(min_size, min_size)) # faux positive
            ...
            cv2.putText(frame, "Touche Q pour quitter", (10, 50), font, 2, (255, 255, 0), 3)
